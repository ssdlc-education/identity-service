...
public class VerificationsApiServiceImpl extends VerificationsApiService {
    ...
    @Override
    public Response verificationsPost(String token, Verification verification, SecurityContext securityContext) throws NotFoundException {
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }

    @Override
    public Response verificationsPut(String token, Verification verification, SecurityContext securityContext) throws NotFoundException {
        return null;
    }
}
