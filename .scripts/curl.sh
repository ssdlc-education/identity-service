...
ssh-keygen -f .secret/ecdsa -t ecdsa -b 256 -q -N ""
mv .secret/ecdsa.pub .secret/token-public.key
mv .secret/ecdsa .secret/token-private.key

ssh-keygen -f .secret/ecdsa -t ecdsa -b 256 -q -N ""
mv .secret/ecdsa.pub .secret/cookie-public.key
mv .secret/ecdsa .secret/cookie-private.key
